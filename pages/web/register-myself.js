...
const RegisterMySelfScreen = () => {
    ...
    const [widthPDF, setWidthPDF] = useState(720)
    ...
    return (
        <>
            ...
            <HeaderBannerContent />
            <TitlePages>
                <h1>ลงทะเบียนด้วยตัวเอง</h1>
                <div className='image-style'>
                    <Image src={titeImage} alt={`titeImage`} />
                </div>
            </TitlePages>
            <WrapperMyShelf>
                ...
                <div className='row'>
                    ...
                    <div className='col-4 col-sm-12 mt-22'>
                        {/* <LabelTitle>วัน เดือน ปี เกิด (Date of birth) *</LabelTitle>
                        <InputBox type="date" /> */}
                        <InputContent
                    ...
                    {/* <div className='col-2 col-sm-4 mt-22'>
                        <InputContent
                            label={'อายุ (Age) *'}
                            placeholder={'0'}
                            value={age}
                            setValue={setAge}
                            require={checkValidate(age, statusValidate)}
                            validName={'โปรดระบุ'}
                        />
                    </div> */}
